...
class App extends Component {
  ...
  instantiateContract() {
    ...
    // Declaring this for later so we can chain functions on Shopfront.
    ...
    this.state.web3.eth.getAccounts((error, accounts) => {
      shopfront.deployed().then((instance) => {
        ...
        return shopfrontInstance.set(5, {from: accounts[0]})
      }).then((result) => {
        // Get the value from the contract to prove it worked.
        return shopfrontInstance.get.call(accounts[0])
      }).then((result) => {
